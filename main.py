...
class APIProject(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (updateCourseRunPageForm,updateCourseRunPageFormFileUpload,updateCourseRunPageSelect,addCourseRunPageOptional, addCourseRunPageFormFileUpload,addCourseRunPageForm, addCourseRunPageSelect, viewCourseRunPage, deleteCourseRunPage, StartPage):
